...
export const TIPOS_MANTEL = ['Rectangular', 'Redondo', 'Cuadrado', 'Ovalado', 'Corrido'];

export const MATERIALES = ['Algodón', 'Poliéster', 'Lino', 'Seda', 'Tul', 'Organza'];

export const CATEGORIAS = ['Boda', 'Corporativo', 'Social', 'Infantil', 'Gala'];
